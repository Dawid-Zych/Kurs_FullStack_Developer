...
function getRandomCustomer() {
	...
	return {
		...
		registerDate: new Date(new Date().getTime() - Math.floor(Math.random() * 1000 * 60 * 60 * 24 * 365 * 5)),
...
try {
	// w pierwszym obiekcie przekazujemy właściwości co mają być zaktualizowane
	// w drugim obiekcie wskazujemy warunki ze względu na które mają być
	// wyszukane el do aktualizacji
	...
	console.log('updatedCustomer1: ', updatedCustomer1); //  updatedCustomer1:  [ 1 ]

	/* upsert - dokonuje aktualizacji danego rekordu jeśli istnieje taki, jeśli nie doda nam taki nowy element */
	...
	console.log('\nupsertedData, created ? ', upsertedCreatedFlag);
